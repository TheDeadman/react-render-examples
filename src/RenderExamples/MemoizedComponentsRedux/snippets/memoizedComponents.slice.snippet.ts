...
// Source: memoizedComponents.slice.ts
// Do not edit this file directly.

const snippet = `import { createSelector, createSlice, PayloadAction } from '@reduxjs/toolkit';
...
export const { incrementCount1, setMultiplier, setUnrelatedState } =
    memoizedComponentsSlice.actions;

export const selectCount1 = (state: RootState) =>
    state.memoizedComponents.count1;
export const selectMultiplier = (state: RootState) =>
    state.memoizedComponents.multiplier;
export const selectUnrelatedState = (state: RootState) =>
    state.memoizedComponents.unrelatedState;
