...
const MemoizedComponentsContext = createContext<
    MemoizedComponentsContextType | undefined
>(undefined);
...
export const MemoizedComponentsProvider: React.FC<
    MemoizedComponentsProviderProps
> = ({ children }) => {
...
export const useMemoizedComponentsContext = () => {
    ...
    if (context === undefined) {
        throw new Error(
            'useMemoizedComponentsContext must be used within a MemoizedComponentsProvider',
        );
    }
    return context;
};
